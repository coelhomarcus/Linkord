...
export function GroupDetailsDrawer({ conversationId, open, onOpenChange, onOpenProfile }: GroupDetailsDrawerProps) {
  const {
  ...
  // the group can disappear out from under an open drawer (deleted, or the
